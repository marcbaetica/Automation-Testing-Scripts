#####################################################################
# The purpose of this was to check if an application was installed.
# Unfortunately it evolved into something with a far greater purpose.
#####################################################################


#grep for confirmation of apps (used later in function dependency_check())
...
#if either one of the two is missing alert the user and exit the script
